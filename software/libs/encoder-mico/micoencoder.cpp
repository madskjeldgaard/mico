...
namespace mico {
  ...
  // STATICS
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  MicoEncoder* MicoEncoder::pio_encoders[][NUM_PIO_STATE_MACHINES] = { { nullptr, nullptr, nullptr, nullptr }, { nullptr, nullptr, nullptr, nullptr } };
  uint8_t MicoEncoder::pio_claimed_sms[] = { 0x0, 0x0 };

  ////////////////////////////////////////////////////////////////////////////////////////////////////
  void MicoEncoder::pio0_interrupt_callback() {
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  void MicoEncoder::pio1_interrupt_callback() {
    //Go through each of encoders on this PIO to see which triggered this interrupt
    for(uint8_t sm = 0; sm < NUM_PIO_STATE_MACHINES; sm++) {
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  MicoEncoder::MicoEncoder(PIO pio, uint8_t pinA, uint8_t pinB, uint8_t pinC,
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  bool MicoEncoder::get_state_a() const {
    return stateA;
  }

  ////////////////////////////////////////////////////////////////////////////////////////////////////
  bool MicoEncoder::get_state_b() const {
    return stateB;
  }

  ////////////////////////////////////////////////////////////////////////////////////////////////////
  int32_t MicoEncoder::get_count() const {
