...
private:
  ...
  static const uint32_t STATES_MASK =
      STATE_A_MASK | STATE_B_MASK | STATE_A_LAST_MASK | STATE_B_LAST_MASK;
...
private:
  ...
  //--------------------------------------------------
public:
  static GPIOEncoder *mico_encoders[NUM_BANK0_GPIOS];
...
public:
  GPIOEncoder() {}
  GPIOEncoder(uint8_t pinA, uint8_t pinB, uint8_t pinC = PIN_UNUSED,
              float counts_per_revolution = DEFAULT_COUNTS_PER_REV,
              bool count_microsteps = DEFAULT_COUNT_MICROSTEPS,
...
public:
  ...
  Direction get_direction() { return last_travel_dir; };
